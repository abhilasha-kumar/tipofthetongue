...
<<>>=
## mergeacc has 3 rows missing
ez::ezDesign(merge_acc, Subject, CuedRecallAcc)
merge_acc[101,] = c(12, 0, 0, 0, 0, 0)
merge_acc[102,] = c(17, 1, 0, 0 ,0, 0)
merge_acc[103,] = c(18, 0, 0, 0, 0, 0)
merge_acc[104,] = c(21, 0, 0, 0, 0, 0)
